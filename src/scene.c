...
/*   Updated: 2018/02/23 15:25:40 by lazuli           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_obj	*init_obj(void)
{
	t_obj	*obj = malloc(sizeof(t_obj) * NUM_OBJ);
	...
	define_obj(&obj[3], 1, 2, 0, new_clr(.3, .3, .3), new_vec(0, 0, -1), 5.5);				//back plane
	...
	// define_obj(&obj[6], 2, 2, 0, new_clr(.1, .4, .1), new_vec(0, -4, 5), 2.5);				//middle sphere
	define_obj(&obj[6], 2, 3, 5.0, new_clr(1, 1, 1), new_vec(0, .5, 3.5), 0.5);				//light source
	// define_obj(&obj[10], 2, 1, 0, new_clr(.4, .4, .4), new_vec(0, .9, 3.5), 0.3);		//light source
	// define_obj(&obj[11], 2, 1, 0, new_clr(.4, .4, .4), new_vec(0, .1, 3.5), 0.3);		//light source
	return obj;
}